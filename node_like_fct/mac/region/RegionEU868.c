...
///////////////////////////////
void printVar(uint32_t var, uint8_t *s)
{
	int8_t i = 0;
	uint8_t Buffer_1[16] = {'_'};
	Buffer_1[15]='\0';
...
vcom_Send("\n\r");
var = phyTxPower;
printVar(var,"phyTxPower : ");

    // Setup the radio frequency
    Radio.SetChannel( Channels[txConfig->Channel].Frequency );
var = Channels[txConfig->Channel].Frequency;
printVar(var,"Frequency : ");

var = bandwidth;
printVar(var,"bandwidth : ");

var = phyDr;
printVar(var,"phyDr : ");

var = phyDr;
printVar(txConfig->Datarate,"DataRate : ");
